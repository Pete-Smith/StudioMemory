...
The structured outline and kanban board state that these classes represent
are for a single project or (life) context (eg, work, school, home).
"""
import sys
...
class ColumnState(DeclarativeBase):
    ...
    def __repr__(self):
        return (
            ...
            f"line_of_commitment={repr(self.line_of_commitment)})>"
        )
